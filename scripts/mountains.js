    ...
    <div class="modal-dialog modal-dialog-centered">
      ...
      <img src="/images/${getMountain.img}" class="card-img-top" alt="...">
        <div class="modal-header">
          <h1 class="modal-title" id="mountainModalLabel">${getMountain.name}</h1>
        </div>
        <div class="modal-body">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><strong>Latitude:</strong> ${getMountain.coords.lat}</li>
            <li class="list-group-item"><strong>Longitude:</strong> ${getMountain.coords.lng}</li>
          </ul>
        </div>
      </div>
    </div>
